...
mysql -hsmzdm_recommend_mysql_m01_184  -urecommendUser -ppVhXTntx9ZG recommendDB -e "drop table article_level_standar_week_$today"
...
"
mysql -hsmzdm_recommend_mysql_m01_184  -urecommendUser -ppVhXTntx9ZG recommendDB -e "TRUNCATE TABLE article_level_standar_week_$today"
