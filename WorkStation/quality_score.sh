...
hive -d zscore='1.96' -d  yuanchuang_para='1' -d yuanchuang_para2='1' -d yuanchuang_para3='1' -d yuanchuang_para4='1' -d store_decrease='0.8' -d score_timestamp='${score_timestamp}' -e '
use recommend;
