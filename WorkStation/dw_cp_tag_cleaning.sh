...
Select b.tag_id,b.user_action_id,b.tag_action_count,b.tag_action_uv_count,b.tag_type_id,b.ds from (
      ...
      from (select * from recommend.dw_cp_tag_statistics_daily_long_term WHERE ds<>"$one_day_ago"  and tag_action_uv_count > 2
            union all
...
Select b.tag_id,b.tag_name,b.tag_type_id,b.tag_weight_estimate,b.tag_weight_machine,b.ds from (
      ...
      from (select * from recommend.dw_cp_dic_tag_info_long_term WHERE ds<>"$one_day_ago"
            union all
...
select "统计标签文章数 好价次数<5:197339  <6:203867  好文次数<2:4841";
...
select "-77778";
CREATE TABLE tabu_tag_list_sift_1 as SELECT a.tag_id,a.tag_name,a.tag_weight_estimate,a.tag_weight_machine,b.user_action_id,b.tag_action_count,b.tag_action_uv_count, b.tag_type_id,a.ds as create_time,b.ds FROM recommend.dw_cp_dic_tag_info_long_term a LEFT OUTER JOIN recommend.dw_cp_tag_statistics_daily_long_term b ON a.tag_id = b.tag_id and a.ds<"$two_week_ago" and b.ds>"$two_week_ago" and a.tag_type_id="400" where b.tag_type_id IS null;
