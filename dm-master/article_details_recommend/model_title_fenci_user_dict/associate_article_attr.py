...
from model_title_fenci_user_dict.model import features_with_weight, SimilaryModel
from model_title_fenci_user_dict.preprocessing import PreProcess
...
if __name__ == "__main__":
    ...
    filename = u"../off_line_file/res_data/未使用自定义分词字典"
