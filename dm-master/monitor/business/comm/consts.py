...
SUB_TIME_WEIGHT = {"HALF_HOUR": TIME_TOTAL_WEIGHT,
					"HOUR_1": TIME_TOTAL_WEIGHT * 4.0 / 5.0,
                    "HOUR_3": TIME_TOTAL_WEIGHT * 3.0 / 5.0,
                    "HOUR_12": TIME_TOTAL_WEIGHT * 2.0 / 5.0,
                    "HOUR_24": TIME_TOTAL_WEIGHT / 5.0}

SUB_PORTRAIT_WIGHT = {"BRAND": PORTRAIT_TOTAL_WEIGHT * 2.0 / 10.0,
                            "ACCURATE_CATE": PORTRAIT_TOTAL_WEIGHT * 4.0 / 10.0,
                            "BLUR_CATE": PORTRAIT_TOTAL_WEIGHT * 2.0 / 10.0,
                            "TAG": PORTRAIT_TOTAL_WEIGHT * 2.0 / 10.0}
